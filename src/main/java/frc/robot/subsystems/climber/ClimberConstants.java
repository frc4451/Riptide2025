...
public class ClimberConstants {
  ...
  public static final Rotation2d trayServoInitialPosition = Rotation2d.fromDegrees(0.0);
  public static final Rotation2d trayServoDeployPosition = Rotation2d.fromDegrees(0.45);
}
