...
public abstract class FollowRollersMagicIOSim implements FollowRollersMagicIO {
  ...
  public void updateInputs(FollowRollersMagicIOInputs inputs) {
    ...
    inputs.positionGoalRotations = positionGoalRotations;
  ...
  public void setGoal(double positionRotations) {
    controller.setGoal(new TrapezoidProfile.State(positionGoalRotations, 0));
    isClosedLoop = true;
  }
