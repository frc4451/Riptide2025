...
public enum SuperStructureModes {
  TUCKED(0.9 / 2.0, Rotation2d.kZero),
  TUCKED_L4(SuperStructureModes.TUCKED.elevatorHeightInches, Rotation2d.fromDegrees(180.0)),
  ...
  L4Coral(49.5 / 2.0, Rotation2d.fromDegrees(180.0)),
